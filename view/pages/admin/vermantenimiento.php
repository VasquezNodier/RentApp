 ...
 <div id="wrapper">  
  <table id='keywords' cellspacing="0" cellpadding="0">
    ...
    <tbody>     
      <tr>
<?php
  $mantenimientos = Mantenimiento::traermantenimiento(Conexion::obtener_conexion(), $idm);
    if (count($mantenimientos)) {
     foreach ($mantenimientos as $mantenimiento) {
?>
        <td><?php echo $mantenimiento->getTipo_mant(); ?></td>
         <td><?php echo $mantenimiento->getFecha(); ?></td>
          <td><?php echo $mantenimiento->getObservaciones(); ?></td>
<?php  } }?>
      </tr>
    </tbody>
  </table>
