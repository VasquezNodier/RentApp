<?php  
        ...
        $vehiculos = VehiculosControl::traervehiculosportipo(Conexion::obtener_conexion(), $tipo);
...
<?php
 ...
 foreach ($parqueaderoo as $parqueadero) {
    ...
    <br><br><br><br>
    <button class="btn" name="btn" value=""> Nuevo <span class="arrow">❯</span></button>
      <button class="btn" name="btn" value=""> Nuevos Implementos de Seguridad <span class="arrow">❯</span></button>
 <div id="wrapper">
  <h1>Motocicletas</h1>
