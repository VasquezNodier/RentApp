<?php  
        ...
        if(isset($_POST['btn1'])){
          $idv=$_POST['btn1'];
        $resultado = VehiculosControl::traervehiculosact(Conexion::obtener_conexion(), $idv);
        if($resultado){
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top navbar-no-bg" role="navigation">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="nav">
            <li><a href="admin.php">Vehiculo Rentado</a>
 ...
 foreach ($parqueaderos as $parqueadero) {
      ...
      <?php  } }?>
        <td><form method="post" action="<?php $_SERVER['PHP_SELF']?>">
         <button class="btn" name="btn1" value="<?php echo $vehiculo->getId_vh(); ?>">Ajustes</button>
        </form></td>
