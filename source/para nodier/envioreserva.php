...
include_once 'configuracion/Conexion.inc.php';
include_once 'configuracion/Redireccion.inc.php';
include_once 'configuracion/config.inc.php';
include_once 'paquetemodelos/Usuario.inc.php';
include_once 'plantillas/documento-declaracion.inc.php';
include_once 'plantillas/navbar.inc.php';
include_once 'controladores/RepositorioRerserva.inc.php';
...
if($cambio){
    $mail = new PHPMailer(true);
        ...
        try {
            ...
            $mail->Username = 'easytravelc2019@gmail.com';                     // SMTP username
            $mail->Password = 'u00110692';                               // SMTP password
            $mail->SMTPSecure = 'tls';                                  // Enable TLS encryption, `ssl` also accepted
            $mail->Port = 587;                                    // TCP port to connect to
            //Recipients
            $mail->setFrom('easytravelc2019@gmail.com', 'reserva de transportes Easy travel');
            $mail->addAddress($email, $nombre_usu);     // Add a recipient
