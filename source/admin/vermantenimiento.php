...
<?php
 ...
 $res = mysqli_query($conexion, "SELECT a.id_vh, a.placa_vh, a.modelo_vh, a.color_vh, b.vehiculo, a.puestos_vh, a.transmision_vh, a.combustible_vh, a.kilometraje_vh, a.estado_vh, a.valorDia_vh, a.seguro_vh, a.observaciones_vh, c.nombre_pq, d.tipo_mant, d.fecha, d.Observaciones FROM vehiculos a, tipoVehiculos b, parqueaderos c,mantenimiento d where a.tipo_vh=b.tipo_vh and a.parqueadero=c.id_pq and a.id_vh='$id_usuario' and a.id_vh=d.id_vh");
                while($usuario = mysqli_fetch_array($res)){
    ...
    <tbody>     
      <tr>
        ...
        <td><?php echo $usuario[12]; ?></td>
         ...
         <thead>
      <tr>
        <th><span>Tipo de mantenimiento</span></th>
        <th><span>Fecha de mantenimiento</span></th>
        <th><span>Observaciones del mantenimiento</span></th>
        
      </tr>
    </thead>
    <tbody>     
      <tr>
        <td class="lalign"><?php echo $usuario[14]; ?></td>
