...
<?php
 ...
 $res = mysqli_query($conexion, "SELECT a.vehiculo, b.id_vh, c.fechaRecibido, c.fechaDevolucion, c.valor_res FROM tipoVehiculos a, vehiculos b, reservas c where b.id_vh=c.id_vh and a.tipo_vh=b.tipo_vh and b.estado_vh='Ocupado' order by a.vehiculo");
                while($usuario = mysqli_fetch_array($res)){
      ...
      <tr>
        ...
        <td><?php echo $usuario[4]; ?></td>
         <td><form action="Vehiculorentado.php" method="post">
