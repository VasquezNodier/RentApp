...
<?php
 ...
 $res = mysqli_query($conexion, "SELECT a.vehiculo, b.id_vh, b.modelo_vh, b.color_vh, b.estado_vh FROM  tipoVehiculos a, vehiculos b where a.tipo_vh=b.tipo_vh and b.estado_vh='Mantenimiento' order by a.vehiculo");
                while($usuario = mysqli_fetch_array($res)){
      ...
      <tr>
        ...
        <td><?php echo $usuario[4]; ?></td>
         <td><form action="vermantenimiento.php" method="post">
